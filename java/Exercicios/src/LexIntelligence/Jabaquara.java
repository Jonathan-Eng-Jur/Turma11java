...
public class Jabaquara extends BaseJudicial {
	...
	public Jabaquara () { }
	 ...
	 public Jabaquara (String nome, String parte, String classe, String assunto, String foro, String chances) {
		super(nome, parte, classe, assunto, foro, chances);
	
	}
	
	public Jabaquara (String nome, String parte, String numProcesso, String classe, String assunto, String foro, int vara, String chances) {
	...
	public void resultado (String parte, String foro) {
		...
		if (parte.equals("J") && foro.equals("3")){ 
