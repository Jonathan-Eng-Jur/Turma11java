...
public class NossaSraO extends BaseJudicial {
	...
	public NossaSraO () { }
	 ...
	 public NossaSraO(String nome, String parte, String classe, String assunto, String foro, String chances) {
		super(nome, parte, classe, assunto, foro, chances);
	
	}
	
	public NossaSraO(String nome, String parte, String numProcesso, String classe, String assunto, String foro, int vara, String chances) {
	...
	public void resultado (String parte, String foro) {
		...
		if (parte.equals("F") && foro.equals("12")){ 
