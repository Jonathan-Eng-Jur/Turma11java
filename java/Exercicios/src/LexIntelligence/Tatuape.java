...
public class Tatuape extends BaseJudicial {
	...
	public Tatuape () { }
	 ...
	 public Tatuape (String nome, String parte, String classe, String assunto, String foro, String chances) {
		super(nome, parte, classe, assunto, foro, chances);
	
	}
	
	public Tatuape (String nome, String parte, String numProcesso, String classe, String assunto, String foro, int vara, String chances) {
	...
	public void resultado (String parte, String foro) {
		...
		if (parte.equals("F") && foro.equals("8")){ 
